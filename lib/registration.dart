                          ...
                          child: DropdownButtonHideUnderline(
                            child: DropdownButton<String>(
                              ...
                              onChanged: (String value) {
                                setState(() {
                                  faculty = value; // saving the selected value
                          ...
                          child: DropdownButtonHideUnderline(
                            ...
                            child: DropdownButton<String>(
                              ...
                              onChanged: (String value) {
                                setState(() {
                                  course = value;
                                  print(course); // saving the selected value
                                });
                              },
                              value: course, // displaying the selected value
                            ),
                          ),
                        ),
                      ),
                        ...
                        child: Theme(
                          ...
                          child: DropdownButtonHideUnderline(
                            ...
                            child: DropdownButton<String>(
                              ...
                              value: hostel_no, // displaying the selected value
                            ),
                          ),
                        ),
                      ),
                        ...
                        child: Theme(
                          ...
                          child: DropdownButtonHideUnderline(
                            ...
                            child: DropdownButton<String>(
                              ...
                              onChanged: (String value) {
                                setState(() {
                                  position = value; // saving the selected value
                                  _dropdownErrorPosition = null;
                                });
                              },
                              value: position, // displaying the selected value
                            ),
                          ),
                        ),
                      ),
                ...
                SizedBox(
                  ...
                  child: RaisedButton(
                    ...
                    onPressed: () {
                      ...
                      if (faculty == null) {
                        setState(() =>
                            _dropdownErrorFaculty = "Please select Faculty");
                        _isValid = false;
                      }
                      if (course == null) {
                        setState(() =>
                      ...
                      if (position == null) {
                        setState(() =>
                            _dropdownErrorPosition = "Please select Positon");
                        _isValid = false;
                      }
